...
<?
if ($_REQUEST['del_filter'] == 'Сбросить'){
	$_REQUEST["arrFilter_where_name"] = "";
}
?>
 <?$APPLICATION->IncludeComponent("bitrix:catalog.smart.filter", "partner_list_filter_no_city", Array(
...
<? 
if (!empty($_REQUEST["arrFilter_where_name"])){
	$arrFilter = array("?NAME" => $_REQUEST["arrFilter_where_name"]);
}
?>

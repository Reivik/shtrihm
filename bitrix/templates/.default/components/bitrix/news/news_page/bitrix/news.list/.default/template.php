...
<?foreach($arResult["ITEMS"] as $arItem):?>
	<div class="item_list_catalog">
		...
		<div class="text">
			<?//pr(htmlspecialchars_decode($arItem['PREVIEW_TEXT'],ENT_QUOTES));?>
			...
			<?elseif($arItem["PREVIEW_TEXT_TYPE"] == "html"):?>
				<p><?=(strlen(strip_tags($arItem['PREVIEW_TEXT'])) > 200 ? substr(washString($arItem['PREVIEW_TEXT']), 0, 200)."..." : strip_tags($arItem['PREVIEW_TEXT']))?></p>
			<?endif;?>
		</div>			
		<div class="show">				

...
?>
	<tr><td><h1>Новостная рассылка компании ШТРИХ-М</h1></td></tr>
<?
...
<p><b>Изменить параметры подписки или отписаться вы можете пройдя по <a href="/subscribe/subscr_edit.php?action=unsubscribe" title="">этой ссылке</a>.</b></p>
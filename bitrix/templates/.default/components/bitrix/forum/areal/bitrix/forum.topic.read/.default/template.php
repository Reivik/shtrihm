...
?>
								...
								<div class="forum-post-moderate selectAllPosts">
									&nbsp;&nbsp;<span class="forum-footer-option forum-footer-selectall forum-footer-option-first"><??><noindex><a rel="nofollow" href="javascript:void(0);" onclick="SelectPosts('<?=$arParams["iIndex"]?>');" name=""><?=GetMessage("F_SELECT_ALL")?></a></noindex></span>
								</div>
								<br>
								<div class="forum-post-moderate messagePostBlock">
									<div class="actionMessageSelectBlock">
										<div class="actionMessageSelect">
								...
								?>
									...
									<input onmousedown="this.form.type.value='messages';this.form.ACTION.value=this.form.ACTION_MESSAGE.value;" <??>type="submit" value="OK"  class="inputBtn actionMessageBtn"/>
								</div>
								<div class="forum-topic-moderate topicPostBlock">
									<div class="actionTSelectBlock">
										<div class="actionMessageSelect">
		...
		?>
									...
									<input onmousedown="this.form.type.value='topic';this.form.ACTION.value=this.form.ACTION_TOPIC.value;" <??>type="submit" value="OK" class="inputBtn actionMessageBtn"/>
								</div>
<?
else:
?>

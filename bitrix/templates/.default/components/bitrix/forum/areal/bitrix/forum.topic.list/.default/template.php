...
?>
						...
						<label class="label_check c_off" for="TID_<?=$res["ID"]?>"  onclick="SelectRow(this.parentNode.parentNode.parentNode)">
							<input name="TID[]" id="TID_<?=$res["ID"]?>" value="<?=$res["ID"]?>" type="checkbox">
							&nbsp;
						</label>
						</div>
<?
...
?>
							<div class="forum-topics-moderate">
								<div class="topicListSelect">
									<div class="forumFooterSelect">
									<select name="ACTION">
	...
	?>
								...
								<input type="submit" value="OK" class="inputBtn topicListBtn"/>
							</div>
<?
						endif;

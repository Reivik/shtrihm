...
');
$APPLICATION->AddHeadString('
<script type="text/javascript" src="//api-maps.yandex.ru/1.1/index.xml?key='.$arParams["KEY"].'"></script>
...
/*			this.container.css({
	...
	this._generateList = function () {
		...
		offices.forEach(function (obj) {
			// �������� ������ �� ������
            //console.log(obj);
			var tr = YMaps.jQuery("<tr class='result_item'><?if(in_array("NAME_SHORT",$arParams["PROPERTY_CODE"])):?><td width='189'>" + obj.name + "</td><?endif;if(in_array("ADDRESS",$arParams["PROPERTY_CODE"])):?><td width='169'>" + obj.adress + "</td><?endif;if(in_array("PHONES",$arParams["PROPERTY_CODE"])):?><td class='center' width='177'>" + obj.phone + "<br/><?endif;if(in_array("WWW",$arParams["PROPERTY_CODE"])):?><a href='" + obj.www + "' target='_blank'>" + obj.www + "</a></td><?endif;if(in_array("PRODUCT_TYPE",$arParams["PROPERTY_CODE"])):?><td width='165'>" + obj.product + "</td><?endif;?><?/*?><td class='center'><a class='send_mail' onclick='feedback_open($(this))' href='javascript:;'>&nbsp;</a></td><?*/?><?/*if(!$arParams["HIDE_LINK_WHEN_NO_DETAIL"] || ($arItem["DETAIL_TEXT"] && $arResult["USER_HAVE_ACCESS"])):?><td class='center'><a href='" + obj.detailUrl + "' target='_top'><?=GetMessage("ITHIVE_OFFICES_DETAIL")?></a></td><?endif;*/?></tr>"),
				td = tr.find("td");
...
if(in_array("NAME_SHORT",$arParams["PROPERTY_CODE"])):?>				<td	width="200"><?=GetMessage("ITHIVE_OFFICES_NAME_SHORT")?></td><?endif;
if(in_array("ADDRESS",$arParams["PROPERTY_CODE"])):?>				<td width="200"><?=GetMessage("ITHIVE_OFFICES_ADDRESS")?></td><?endif;
if(in_array("PHONES",$arParams["PROPERTY_CODE"])):?>				<td	width="200"><?=GetMessage("ITHIVE_OFFICES_PHONES")?></td><?endif;
if(in_array("PRODUCT_TYPE",$arParams["PROPERTY_CODE"])):?>				<td width="200"><?=GetMessage("ITHIVE_OFFICES_PRODUCT_TYPE")?></td><?endif;

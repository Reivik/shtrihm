...
<?$ElementID=$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"COUNT_SPECIAL_OFFERS" => $arParams["COUNT_SPECIAL_OFFERS"],
		"SPECIAL_OFFERS_IMG_WIDTH" => $arParams["SPECIAL_OFFERS_IMG_WIDTH"],
		"SPECIAL_OFFERS_IMG_HEIGHT" => $arParams["SPECIAL_OFFERS_IMG_HEIGHT"],
		"INTRODUCTION_IMG_WIDTH" => $arParams["INTRODUCTION_IMG_WIDTH"],
		"INTRODUCTION_IMG_HEIGHT" => $arParams["INTRODUCTION_IMG_HEIGHT"],
	
		"ADD_SECTIONS_CHAIN" => "Y"
	),
	$component
);?>
<?$APPLICATION->IncludeComponent("areal:online.consultant", ".default", array("PRODUCT_ID" => $ElementID));?>

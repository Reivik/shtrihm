...
<div id="product_detail" class="list_item_tabs">
	...
	<? } elseif($arResult["PROPERTIES"]["buy"]["VALUE"]=="") {?>
	<a href="/partners_info/partners/?directions=<?=$arResult["IBLOCK_SECTION_ID"]?>" class="pay"><span>Где купить?</span></a>
	<? } else { ?>
	<? $pars_url=strpos($arResult["PROPERTIES"]["buy"]["VALUE"], "://")?substr($arResult["PROPERTIES"]["buy"]["VALUE"], strpos($arResult["PROPERTIES"]["buy"]["VALUE"], "://")+3):$arResult["PROPERTIES"]["buy"]["VALUE"]; ?>
	<a href="//<?=$pars_url?>/" target="_blank" rel="nofollow" class="pay"><span>Где купить?</span></a>
	<? } ?>
	<div class="clear"></div>
	<div id="description">
		<div>

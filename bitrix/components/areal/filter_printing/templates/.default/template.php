...
<a name="filter"></a>
<form name="printing_products" class="filter_form" action="<?=$APPLICATION->GetCurPage()?>#filter" method="get">
	<?if(!empty($arResult["DIRECTIONS"])):?>
		<div class="field">
			<select name="directions">
				<option value="0" <?if($_REQUEST["directions"] == 0):?> selected="selected" <?endif;?> >Все</option>

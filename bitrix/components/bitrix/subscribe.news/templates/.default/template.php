...
?>
	<tr><td><h1 style="font-family: 'PT Sans', 'Arial', sans-serif;"><?=$arIBlock['NAME']?></h1></td></tr>
<?
...
?>
	<tr><td>
		<font style="font-family: 'PT Sans', 'Arial', sans-serif;" class="text">
		<?if($arItem["PREVIEW_PICTURE"]):?>
		...
		<?if(strlen($arItem["DATE_ACTIVE_FROM"])>0):?>
			<font style="font-family: 'PT Sans', 'Arial', sans-serif;" class="newsdata"><?echo $arItem["DATE_ACTIVE_FROM"]?></font><br>
		<?endif;?>
		<a style="font-family: 'PT Sans', 'Arial', sans-serif;" href="<?echo $arItem["DETAIL_PAGE_URL"]?>"><b><?echo $arItem["NAME"]?></b></a><br>

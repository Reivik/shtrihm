...
$APPLICATION->AddHeadString('<link rel="stylesheet" href="/design/css/new_news_styles.css?23" type="text/css" />');
$APPLICATION->SetPageProperty("SUBSCRIBE_FORM", "N");
$APPLICATION->SetPageProperty("NO_LEFT_MENU", "N");
$APPLICATION->SetTitle("Информационные статьи");
?>
<?$GLOBALS['arrSectFilter'] = array("PROPERTY_DZEN_VALUE" => "Y");?>
    <?$APPLICATION->IncludeComponent("bitrix:news", "news_dzen", array(
